...
\hline
25 & Mở khóa chương trả phí & Chapter khóa; số dư đủ & HTTP \texttt{200},\newline\texttt{CHAPTER\_\allowbreak{}UNLOCKED} & Trừ đúng chi phí và trả số dư mới & Chi phí \texttt{10}, số dư mới đúng (\textbf{Đạt}) \\
\hline
...
\hline
27 & Số dư không đủ khi mở khóa & Balance \texttt{4}, unlock cost \texttt{10} & HTTP \texttt{409},\newline\texttt{INSUFFICIENT\_\allowbreak{}CRYSTALS} & Không mở khóa; trả số dư hiện tại & HTTP \texttt{409}, balance \texttt{4} (\textbf{Đạt}) \\
\hline
