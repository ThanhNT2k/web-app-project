...
router.get('/:id/rating', optionalAuth, storyController.getStoryRating);
router.put('/:id/rating', authenticateToken, storyController.rateStory);
router.delete('/:id/rating', authenticateToken, storyController.deleteStoryRating);
